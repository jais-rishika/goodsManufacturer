import type { ToolCribsAction, ToolCribsState } from "./ToolCribs.types";

export const toolCribsInitialState: ToolCribsState = {
  isLoading: false,
  error: "",
  addModal: false,
  deleteModal: false,
...
export const ToolCribsReducer = (
  prevState: ToolCribsState,
  action: ToolCribsAction
): ToolCribsState => {
  ...
  switch (action.type) {
    ...
    case "GET_DATA_SUCCESS":
      return { ...prevState, isLoading: false, ToolCribsTableData: action.data };
