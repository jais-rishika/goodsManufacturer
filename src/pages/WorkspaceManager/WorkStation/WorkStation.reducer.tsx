import type { WorkStationAction, WorkStationState } from "./WorkStation.types";

export const workStationInitialState: WorkStationState = {
  isLoading: false,
  error: "",
  addModal: false,
  deleteModal: false,
...
export const workStationReducer = (
  ...
  switch (action.type) {
    ...
    case "GET_DATA_SUCCESS":
      return { ...prevState, isLoading: false, workStationTableData: action.data };
